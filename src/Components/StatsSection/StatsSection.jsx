...
const StatsSection = () => {
    ...
    return (
        <div className="py-16 text-base-content bg-base-100">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className="text-3xl md:text-5xl text-primary font-extrabold uppercase mb-2">Our Impact</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                    <div className="p-6 rounded-2xl bg-base-200 border border-base-300 transform hover:scale-105 transition-transform duration-300">
