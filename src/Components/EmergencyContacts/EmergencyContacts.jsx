        ...
        <div className="bg-base-200 py-16">
             <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className="text-3xl md:text-5xl font-extrabold text-base-content uppercase mb-2">Emergency Contacts</h2>
                    <p className="text-base-content/70">Quick access to essential emergency services in your area.</p>
                    <div className="w-24 h-1 bg-red-500 mx-auto mt-4 rounded"></div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {services.map(service => (
                        <div key={service.id} className="bg-base-100 rounded-xl shadow-lg hover:shadow-xl transition-shadow p-6 flex flex-col items-center text-center relative overflow-hidden group">
                            ...
                            <h3 className="text-xl font-bold text-base-content">{service.name}</h3>
                            <p className="text-base-content/60 text-sm mb-6">{service.desc}</p>
