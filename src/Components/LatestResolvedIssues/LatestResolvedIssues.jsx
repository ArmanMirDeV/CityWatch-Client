    ...
    return (
        <section className="py-16 bg-gradient-to-br from-indigo-50 to-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {issues.length === 0 ? (
                    <div className="text-center text-gray-500 italic">No resolved issues yet. Be the first to witness change!</div>
                ) : (
                        ...
                        {issues.map((issue, index) => (
                            ...
                            >
                                ...
                                <div className="p-6 flex-grow flex flex-col">
                                    <h3 className="text-xl font-bold text-gray-800 mb-2 line-clamp-1" title={issue.title}>
                                        {issue.title}
                                    </h3>
